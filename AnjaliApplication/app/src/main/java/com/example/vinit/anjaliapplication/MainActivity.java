package com.example.vinit.anjaliapplication;
        ...
        b1.setOnLongClickListener(
                new Button.OnLongClickListener(){
                    public boolean onLongClick(View v){
                        ...
                        main_view.setBackgroundResource(R.drawable.young);
                        return true;
                    }
                }
        );
...
//        b1.setText("Swipe Me  <-");
    ...
    public void onLongPress(MotionEvent e) {
        main_view.setBackgroundResource(R.drawable.me);
        b1.setText("Finish");
    }
    ...
    public void onSwipeRight()
    {
        ...
        t1.setTextColor(Color.parseColor("#ff0000"));
        t2.setTextColor(Color.parseColor("#ff0000"));
        main_view.setBackgroundResource(R.drawable.dhaval);
    }
    public void onSwipeLeft()
    {
        Log.i(TAG, "Left");
        b1.setText("Swipe Me Up");
        t1.setText("- All wHite Ppl");
        t1.setTextColor(Color.parseColor("#ff0000"));
        t2.setTextColor(Color.parseColor("#ff0000"));
        main_view.setBackgroundResource(R.drawable.dine);
    ...
    public void onSwipeTop()
    {
        ...
        t1.setTextColor(Color.parseColor("#ffffff"));
        t2.setTextColor(Color.parseColor("#ffffff"));
        main_view.setBackgroundResource(R.drawable.sleep);
        //Toast.makeText(MainActivity.this, "top", Toast.LENGTH_SHORT).show();
    }
